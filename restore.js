...
const originalContent = `import { VideoShowcaseItem, GalleryItem, SpeakingEngagement, WorkExperience, SkillCategory } from '../types';

export const PERSONAL_INFO = {
  name: 'TONI WINDRA, S.T., CVES',
  ...
  shortBio: 'Berkomitmen mengintegrasikan keahlian teknis dan manajemen untuk mencetak SDM yang mandiri, berkarakter, dan berdampak sosial.',
  stats: [
...
fs.writeFileSync('src/data/portfolioData.ts', originalContent);
